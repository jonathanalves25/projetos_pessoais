...
export const Socials = () => {
  return (
    <div className="text-stone-800 flex sm:flex-col justify-center gap-2 mt-6 sm:mt-0 sm:gap-8 sm:-mr-48 text-3xl w-60 font-sans">
      ...
      <div className="px-2 py-1 bg-indigo-200 text-gray-800 sm:mr-6 hover:-ml-28 w-auto hover:ease-in hover:duration-300 ease-out duration-300 rounded">
      ...
      <div className="px-2 py-1 bg-indigo-200 text-gray-800 sm:mr-6 hover:-ml-24 w-auto hover:ease-in hover:duration-300 ease-out duration-300 rounded">
      ...
      <div className="px-2 py-1 bg-indigo-200 text-gray-800 sm:mr-6 hover:-ml-36 w-auto hover:ease-in hover:duration-300 ease-out duration-300 rounded">
