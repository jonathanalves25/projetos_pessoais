...
export const Home = () => {
  return(
    <div className="container-full h-3/4 flex flex-col sm:flex-row justify-center sm:justify-end items-center overflow-hidden">
      <div className="container text-yellow-300 mx-auto flex justify-center sm:justify-between">
          <div className="flex flex-col justify-center w-4/4 sm:w-2/4">
            <h2 className="text-5xl md:text-4xl lg:text-6xl md:pl-10 xl:pl-0 xl:text-8xl font-sans">Jonathan <span className="text-stone-800">Alves</span></h2>
            <p className="text-3xl ml-2 md:text-2xl lg:text-4xl md:pl-10 xl:pl-0 xl:text-5xl pt-4 font-sans">Front-end Developer</p>
          ...
          <div className="sm:flex justify-center hidden sm:block">
            <div className="md:w-2/3 lg:w-2/3 lg:h-3/3 xl:w-full xl:h-4/4 bg-gradient-to-b from-indigo-200 to-indigo-400 rounded-full overflow-hidden">
